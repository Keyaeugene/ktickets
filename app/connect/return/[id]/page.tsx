      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-green-500 to-green-600 p-6 text-white text-center">
            ...
            <h2 className="text-2xl font-bold mb-2">M-Pesa Account Connected!</h2>
            <p className="text-green-100">
              Your M-Pesa account has been successfully set up
            </p>
          </div>
            ...
            <div className="space-y-4">
              <div className="bg-green-50 border border-green-100 rounded-lg p-4">
                ...
                <ul className="text-sm text-green-700 space-y-2">
                  ...
                  <li>
                    • Payments will be processed through your M-Pesa account
                  </li>
                  <li>• Funds will be transferred automatically to your phone</li>
                </ul>
              </div>
